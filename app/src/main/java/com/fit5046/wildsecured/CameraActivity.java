                ...
                new BottomSheetBehavior.BottomSheetCallback() {
                    ...
                    public void onStateChanged(@NonNull View bottomSheet, int newState) {
                        switch (newState) {
                            ...
                            {
                                bottomSheetArrowImageView.setImageResource(R.drawable.ic_baseline_arrow_downward_24);
                            }
                            break;
                            case BottomSheetBehavior.STATE_COLLAPSED:
                            {
                                bottomSheetArrowImageView.setImageResource(R.drawable.ic_baseline_arrow_upward_24);
                            }
                            break;
